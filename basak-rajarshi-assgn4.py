# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 20:49:55 2017
...
import operator
file = open("gene-trainF17.txt","r").readlines()
outputfile = open("F17-assgn4-test-output1.txt", 'w')
inputfile = open("F17-assgn4-test.txt","r").readlines()
inputfile.append("\n")
inputfile.append("\n")
iput=""
unsortedwordtags = []
